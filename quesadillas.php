...
<head>
    ...
    <link rel="stylesheet" href="css/quesadillas.css">
...
<div class="comidas">
    <ul>
        ...
        <li><a href="" class="quesadillas">Quesadillas</a></li>
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/quesadilla con carne.jpeg" alt="" class="camaronimg">
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/quesadillas con camaron.jpeg" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>Con camaron</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
...
<div class="sin_nombres">
    <!--Jamon-->
    <div class="otrosp">
        <p class="nombrespedidos"><b>Jamons</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
    ...
    <div class="otrosp">
        ...
        <p class="nombrespedidos"><b>Quesapizza</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
    ...
    <!--Chorizo-->
    <div class="otrosp">
        <p class="nombrespedidos"><b>Chorizo</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
    ...
    <!--Suprema-->
    <div class="otrosp">
        <p class="nombrespedidos"><b>Suprema</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>

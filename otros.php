...
<div class="comidas">
    <ul>
        ...
        <li><a href="" class="otros">Otros</a></li>
    </ul>
</div>
</br>
</br>
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/falutas con carne.jpeg" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>Flautas de carne</b></p>
        <div class="carrito">
        <button type="button">
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/aros de cebollas.jpeg" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>Aros de cebolla</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>

...
<div class="comidas">
    <ul>
        ...
        <li><a href="" class="tortas">Tortas</a></li>
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/mostro.jpeg" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>Mostro</b></p>
        <div class="carrito">
        <button type="button">
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/Mixta.jpeg" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>Mixta</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/adobada.jpeg" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>Adobada</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/de pavo.jpeg" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>De pavo</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
...
<div class="sin_nombres">
    <!--Pavo especial-->
    <div class="otrosp">
        <p class="nombrespedidos"><b>Pavo especial</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
    ...
    <!--Jamon y winne-->
    <div class="otrosp">
        <p class="nombrespedidos"><b>Jamon y winne</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
    ...
    <!--Jamon y queso blanco-->
    <div class="otrosp">
        <p class="nombrespedidos"><b>Jamon y queso blanco</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
    ...
    <!--Adobada especial-->
    <div class="otrosp">
        <p class="nombrespedidos"><b>Adobada especial</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>

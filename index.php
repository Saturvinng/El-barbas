...
<header>
    <nav class="nav">
        ...
        <div class="logo"><a ><img src="./img/1666882906975.png" alt=""></a></div>
        <ul class="menu2">
...
<div class="imagenes">
<div class="img1">
    <img src="./img/parte_arriba.jpg" alt="">
</div>
<div class="img2">
    <img src="./img/parte_abajo.jpg" alt="">
</div>
<div class="elbarbas">
    <p class="titulo">
        El Barbas
    </p>
    <p class="info">@elbarbashamburguesa</p>
</div>
</div>

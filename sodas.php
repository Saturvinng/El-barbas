...
<head>
    ...
    <link rel="stylesheet" href="css/sodas.css">
...
<div class="comida">
    ...
    <div class="comidas">
    <ul>
        <li><a href="agias_frescas.php" class="AguasF">Aguas Frecas</a></li>
        <li><a href="agia.php" class="agua">Agua</a></li>
        <li><a href="jugos.php" class="jugos">Jugos</a></li>
        <li><a href="" class="sodas">Sodas</a></li>
    </ul>
</div>
</br>
</br>
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/cocacola.png" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>Coca-cola</b></p>
        <div class="carrito">
        <button type="button">

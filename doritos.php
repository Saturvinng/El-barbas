...
<head>
    ...
    <link rel="stylesheet" href="css/doritos.css">
...
<div class="comidas">
    <ul>
        ...
        <li><a href="" class="doritos">Doritos Preparados</a></li>
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/dorinachos puercos.jpeg" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>Dori puercos</b></p>
        <div class="carrito">
        <button type="button">
...
<div class="burgues">
    <div class="camaron">
        ...
        <img src="./img/dorinachos con carne.jpeg" alt="" class="camaronimg">
        <p class="nombrespedidos"><b>Dorinachos con carne</b></p>
        <div class="carrito">
        <button type="button">
            <img src="./img/anadir-a-la-cesta.png" alt="agregar al carrito">
        </button>
